...
<html>
   <head>
      ...
      <title>Welcome to ShopATN</title>
            ...
            <div class="container">
               <div id="sequence">
                  ...
                  <ul class="sequence-canvas">
                     <li class="animate-in">
                        <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead">Miss clothes 2020</span></div>
                        <div class="flat-caption caption2 formLeft delay400 text-center">
                           <h1>Hot summer.</h1>
                        </div>
                        <div class="flat-caption caption3 formLeft delay500 text-center">
                           <p>Simplicity in dress.<br> Quality and reasonable price.</p>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Váy Ngắn 2020</div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Váy Mùa hè</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Quần áo đẹp</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Đầm mùa hè</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Váy đẹp</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="productname">Váy ngắn</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.html"><img src="images/products/small/products-04.png" alt="Product Name"></a></div>
                                 <div class="productname">Váy ok</div>
                                 <h4 class="price">$451.00</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Add To Cart</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
         ...
         <div class="footer">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        ...
                        <p>88 Ngo quyen, Da nang, Vietnam</p>
                        <p>Call Us : 01654165578</p>
                        <p>Email : hungvngcd18770@fpt.edu.vn</p>
                     </div>
                     <div class="col-md-3 col-sm-6">
            ...
            <div class="copyright-info">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <p>Cungduoc © 2020. Designed by <a href="#">Taolao</a>. Vuitinhqua</p>
                     </div>
                     <div class="col-md-6">
